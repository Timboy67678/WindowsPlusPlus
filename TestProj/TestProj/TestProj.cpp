...
INT_PTR CALLBACK MainDialog::OnOK(WORD wControlID, HWND hWnd, WPARAM wParam, LPARAM lParam)
{
	m_list->ResetContent();
...
INT_PTR CALLBACK MainDialog::OnMenuExit(WORD wControlID, HWND hWnd, WPARAM wParam, LPARAM lParam)
{
	EndDialog();
	return FALSE;
}

INT_PTR CALLBACK MainDialog::OnMenuAbout(WORD wControlID, HWND hWnd, WPARAM wParam, LPARAM lParam)
{
	MsgBoxInfo(TEXT("TestProj"), TEXT("TestProj.exe - Test project for use in WinPlusPlus!"));
	return FALSE;
}

INT_PTR CALLBACK MainDialog::OnCheckBoxClicked(WORD wControlID, HWND hWnd, WPARAM wParam, LPARAM lParam)
{
