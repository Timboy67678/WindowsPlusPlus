	...
	*/
	...
	public:
		...
		*/
		 ...
		 */
		virtual bool create_window(std::shared_ptr<layout::panel> layout, HWND parent_window = HWND_DESKTOP, LPVOID param = NULL);
		 ...
		 */
		virtual bool run_window(std::shared_ptr<layout::panel> layout, HWND parent_window = HWND_DESKTOP, LPVOID param = NULL);
		...
		*/
		...
		// Create window controls (position handled by layout system)
		...
		/**
		 * @brief Gets the layout panel.
		 * @return Shared pointer to the layout panel.
		 */
